...
const Bottoms = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-purple-100 py-10 rounded-xl shadow-lg">
      <div className="max-w-screen-xl mx-auto px-4">
        <div className="text-center mb-6">
          <h1 className="text-4xl md:text-5xl font-bold text-purple-600 drop-shadow">
            Stylish Bottoms Collection
          </h1>
          <p className="text-gray-600 mt-2 text-lg">Explore your perfect bottoms for any occasion</p>
        </div>
          ...
          <div className="flex flex-wrap justify-between items-stretch gap-4">
            <div className="flex flex-wrap items-end gap-4 bg-white p-6 rounded-xl shadow-lg flex-grow">
              <div className="flex flex-col">
                ...
                <select
                  ...
                  className="min-w-[150px] border border-gray-300 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-400"
                >
              ...
              <div className="flex flex-col">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="w-[80px] px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400"
                  />
              ...
              <div className="flex-shrink-0">
                <button
                  ...
                  className="bg-purple-600 hover:bg-purple-700 text-white font-semibold px-5 py-2 rounded-lg transition duration-200"
                >
                  Apply
                </button>
              </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg flex flex-col justify-start flex-grow min-w-[200px]">
              ...
              <select
                ...
                className="min-w-[160px] border border-gray-300 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-400"
              >
