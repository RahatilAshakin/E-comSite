...
const Kids = () => {
  const products = useLoaderData(); // Kids product JSON array
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-amber-100 py-10">
      <div className="max-w-screen-xl mx-auto px-4">
        {/* Title and subtitle */}
        <div className="text-center mb-6">
          <h1 className="text-4xl md:text-5xl font-bold text-blue-600 drop-shadow">
            Fun & Trendy Kids Collection
          </h1>
          <p className="text-gray-600 mt-2 text-lg">
            Explore playful styles and fresh picks for your little ones
          </p>
        </div>
            ...
            <div className="flex flex-wrap items-end gap-4 bg-white p-6 rounded-xl shadow-lg flex-grow">
              ...
              <div className="flex flex-col">
                ...
                <select
                  ...
                  className="min-w-[150px] border border-gray-300 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
                >
              ...
              <div className="flex flex-col">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="w-[80px] px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
                  />
        ...
        <div className="col-span-1 lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          ...
          {paginatedProducts.length === 0 ? (
            ...
            paginatedProducts.map((product, idx) => (
              <div
                key={`${product.id}-${idx}`}
                className="group relative bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-2xl transform transition duration-300 hover:-translate-y-1 hover:border-blue-400"
              >
                {" "}
                {/* Product Image & Label */}{" "}
                <div className="relative">
                  ...
                  <img
                    ...
                    alt={product.title}
                  />{" "}
                  <span className="absolute top-3 left-3 bg-blue-500 text-white text-xs font-bold px-2 py-1 rounded-full shadow">
                    {" "}
                    KIDS{" "}
                  </span>{" "}
                </div>{" "}
                ...
                <div className="p-5">
                  {" "}
                  <h2 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-blue-600 transition line-clamp-2">
                    {" "}
                    {product.title}{" "}
                  </h2>{" "}
                  <div className="flex items-center justify-between gap-2 mb-4">
                    ...
                    <span className="text-blue-600 capitalize font-bold text-sm">
                      {" "}
                      {product.condition}{" "}
                    </span>{" "}
                  </div>{" "}
                  ...
                  <a
                    ...
                    className="inline-block w-full text-center py-2 bg-gradient-to-r from-blue-400 to-blue-500 text-white font-semibold rounded-lg hover:from-blue-500 hover:to-blue-600 transition duration-300"
                  >
                    {" "}
                    View Product{" "}
                  </a>{" "}
