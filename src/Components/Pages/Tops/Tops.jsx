...
const Tops = () => {
  const products = useLoaderData(); // Tops product JSON array
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-100 py-10 rounded-xl shadow-lg">
      <div className="max-w-screen-xl mx-auto px-4">
        {/* Title */}
        <div className="text-center mb-6">
          <h1 className="text-4xl md:text-5xl font-bold text-green-600 drop-shadow">
            Trendy & Casual Tops Collection
          </h1>
          <p className="text-gray-600 mt-2 text-lg">
            Browse the latest and most comfortable tops for every style
          </p>
        </div>
